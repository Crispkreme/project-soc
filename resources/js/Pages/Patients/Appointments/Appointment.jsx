                    ...
                    <div className='relative border-2 rounded-md border-black bg-white p-4 z-50'>

                      {
                        [
                          ...
                          {
                            head: "WHEN",
                            item: `${new Date(barangayEvents.event_date + 'T' + barangayEvents.event_start).toLocaleString('en-US', {
                              timeZone: 'Asia/Manila',
                              year: 'numeric',
                              month: 'long',
                              day: 'numeric',
                            })} ${new Date(barangayEvents.event_date + 'T' + barangayEvents.event_start).toLocaleTimeString('en-US', {
                              hour: 'numeric',
                              minute: '2-digit',
                              hour12: true,
                            })} - ${new Date(barangayEvents.event_date + 'T' + barangayEvents.event_end).toLocaleTimeString('en-US', {
                              hour: 'numeric',
                              minute: '2-digit',
                              hour12: true,
                            })}`
