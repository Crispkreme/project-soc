...
const AccountModal = ({ showModal, toggleModal, userDetail }) => {
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="w-full">
                        ...
                        <textarea
                            ...
                            className="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 mt-1 block w-full mt-4"
                        />
