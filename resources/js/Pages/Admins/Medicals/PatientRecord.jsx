...
const PatientRecord = ({ patient, healthRecords, surgicalRecords, medicationRecords, familyMedicalRecords }) => {
  return (
                      ...
                      <table className="w-full min-w-[540px]" data-tab-for="order" data-page="active">
                        ...
                        <tbody>
                          {surgicalRecords.length > 0 ? surgicalRecords.map((surgicalRecord) => (
                            ...
                            <tr>
                              <td colSpan={4} className="text-center py-4 text-gray-500">No Medicine Available.</td>
                            </tr>
                          )}      
                        </tbody>
                        </table>
